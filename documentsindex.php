...
/**
 *	\file       documents/documentsindex.php
 *	\ingroup    documents
 *	\brief      Home page of documents top menu
 */
...
$langs->loadLangs(array("documents@documents"));

$action = GETPOST('action', 'alpha');


// Security check
//if (! $user->rights->documents->myobject->read) accessforbidden();
...
llxHeader("", $langs->trans("DocumentsArea"));

print load_fiche_titre($langs->trans("DocumentsArea"), '', 'documents.png@documents');
...
// Draft MyObject
if (! empty($conf->documents->enabled) && $user->rights->documents->read)
{
	$langs->load("orders");
