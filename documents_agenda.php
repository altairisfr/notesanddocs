...
/**
 *  \file       documents_agenda.php
 *  \ingroup    documents
 *  \brief      Page of Documents events
 */
...
$hookmanager->initHooks(array('documentsagenda', 'globalcard')); // Note that conf->hooks_modules contains array
// Fetch optionals attributes and labels
$extrafields->fetch_name_optionals_label($object->table_element);

// Load object
include DOL_DOCUMENT_ROOT.'/core/actions_fetchobject.inc.php'; // Must be include, not include_once  // Must be include, not include_once. Include fetch and fetch_thirdparty but not fetch_optionals
if ($id > 0 || !empty($ref)) $upload_dir = $conf->documents->multidir_output[$object->entity]."/".$object->id;
...
if ($object->id > 0)
{
	...
	dol_fiche_head($head, 'agenda', $langs->trans("Documents"), -1, 'object_'.$object->picto);
	...
	if (!empty($conf->agenda->enabled) && (!empty($user->rights->agenda->myactions->read) || !empty($user->rights->agenda->allactions->read)))
	{
		...
		//print load_fiche_titre($langs->trans("ActionsOnDocuments"), '', '');
