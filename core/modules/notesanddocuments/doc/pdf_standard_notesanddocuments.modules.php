...
/**
 *  \file       core/modules/notesanddocuments/doc/pdf_standard.modules.php
...
/**
 *	Class to manage PDF template standard_notesanddocuments
 */
class pdf_standard_notesanddocuments extends ModelePDFNotesAndDocuments
{
    /**
	...
	*/
	...
	public function write_file($object, $outputlangs, $srctemplatepath = '', $hidedetails = 0, $hidedesc = 0, $hideref = 0)
	{
	    ...
	    /*
	    if (!empty($conf->global->MAIN_GENERATE_NOTESANDDOCUMENTS_WITH_PICTURE))
	    {
		...
		*/
	    ...
	    if ($conf->notesanddocuments->dir_output.'/notesanddocuments')
	    {
	        ...
	        if ($object->specimen)
	        {
	        	$dir = $conf->notesanddocuments->dir_output.'/notesanddocuments';
	            $file = $dir."/SPECIMEN.pdf";
	        } else {
	            $objectref = dol_sanitizeFileName($object->ref);
	            $dir = $conf->notesanddocuments->dir_output.'/notesanddocuments/'.$objectref;
