...
/**
 *  \file       documents/core/modules/documents/doc/pdf_standard.modules.php
 *  \ingroup    documents
	...
	*/
	...
	public function write_file($object, $outputlangs, $srctemplatepath = '', $hidedetails = 0, $hidedesc = 0, $hideref = 0)
	{
		...
		*/
	    ...
	    if ($conf->documents->dir_output.'/myobject')
	    {
	        ...
	        if ($object->specimen)
	        {
	        	$dir = $conf->documents->dir_output.'/myobject';
	            $file = $dir."/SPECIMEN.pdf";
	        } else {
	            $objectref = dol_sanitizeFileName($object->ref);
	            $dir = $conf->documents->dir_output.'/myobject/'.$objectref;
