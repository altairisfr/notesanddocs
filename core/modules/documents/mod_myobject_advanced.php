...
/**
 * \file       htdocs/core/modules/documents/mod_myobject_advanced.php
 * \ingroup    documents
...
class mod_myobject_advanced extends ModeleNumRefMyObject
{
	...
	public function info()
	{
		...
		$texte .= '<input type="hidden" name="maskconst" value="DOCUMENTS_MYOBJECT_ADVANCED_MASK">';
		...
		$texte .= '<td class="right">'.$form->textwithpicto('<input type="text" class="flat" size="24" name="maskvalue" value="'.$conf->global->DOCUMENTS_MYOBJECT_ADVANCED_MASK.'">', $tooltip, 1, 1).'</td>';
	...
	public function getNextValue($object)
	{
		...
		// We get cursor rule
		$mask = $conf->global->DOCUMENTS_MYOBJECT_ADVANCED_MASK;
		...
		$numFinal = get_next_value($db, $mask, 'documents_myobject', 'ref', '', null, $date);
