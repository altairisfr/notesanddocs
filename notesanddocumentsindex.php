...
/**
 *	\file       notesanddocuments/notesanddocumentsindex.php
 *	\ingroup    notesanddocuments
 *	\brief      Home page of notesanddocuments top menu
 */
...
$langs->loadLangs(array("notesanddocuments@notesanddocuments"));

$action = GETPOST('action', 'alpha');


// Security check
//if (! $user->rights->notesanddocuments->myobject->read) accessforbidden();
...
llxHeader("", $langs->trans("NotesAndDocumentsArea"));

print load_fiche_titre($langs->trans("NotesAndDocumentsArea"), '', 'notesanddocuments.png@notesanddocuments');
...
// Draft MyObject
if (! empty($conf->notesanddocuments->enabled) && $user->rights->notesanddocuments->read)
{
	$langs->load("orders");
