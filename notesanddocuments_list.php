...
/**
 *   	\file       notesanddocuments_list.php
 *		\ingroup    notesanddocuments
 *		\brief      List page for notesanddocuments
 */
...
require_once __DIR__.'/class/notesanddocuments.class.php';
...
$contextpage = GETPOST('contextpage', 'aZ') ? GETPOST('contextpage', 'aZ') : 'notesanddocumentslist'; // To manage different context of search
...
$hookmanager->initHooks(array('notesanddocumentslist')); // Note that conf->hooks_modules contains array
...
if (empty($reshook))
{
	...
	// Mass actions
	$objectclass = 'NotesAndDocuments';
	$objectlabel = 'NotesAndDocuments';
...
if ($num == 1 && !empty($conf->global->MAIN_SEARCH_DIRECT_OPEN_IF_ONLY_ONE) && $search_all && !$page)
{
	...
	$id = $obj->rowid;
	header("Location: ".dol_buildpath('/notesanddocuments/notesanddocuments_card.php', 1).'?id='.$id);
	exit;
}
...
$newcardbutton = dolGetButtonTitle($langs->trans('New'), '', 'fa fa-plus-circle', dol_buildpath('/notesanddocuments/notesanddocuments_card.php', 1).'?action=create&backtopage='.urlencode($_SERVER['PHP_SELF']), '', $permissiontoadd);

print_barre_liste($title, $page, $_SERVER["PHP_SELF"], $param, $sortfield, $sortorder, $massactionbutton, $num, $nbtotalofrecords, 'object_'.$object->picto, 0, $newcardbutton, '', $limit, 0, 0, 1);

// Add code for pre mass action (confirmation or email presend form)
$topicmail = "SendNotesAndDocumentsRef";
$modelmail = "notesanddocuments";
$objecttmp = new NotesAndDocuments($db);
