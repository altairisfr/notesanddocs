...
/**
 *  \file       documents_note.php
 *  \ingroup    documents
 *  \brief      Car with notes on Documents
 */
...
$langs->loadLangs(array("documents@documents", "companies"));
...
$hookmanager->initHooks(array('documentsnote', 'globalcard')); // Note that conf->hooks_modules contains array
...
if ($id > 0 || !empty($ref))
{
	...
	dol_fiche_head($head, 'note', $langs->trans("Documents"), -1, $object->picto);
